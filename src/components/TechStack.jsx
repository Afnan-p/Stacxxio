        ...
        <div className="relative group">
          ...
          >
            {techs.map((tech) => (
              ...
              >
                <div className="flex flex-col items-center justify-center aspect-square p-4 rounded-[18px] bg-white/5 backdrop-blur-md border border-white/10 group cursor-default transition-all duration-500 hover:border-brand-accent/30 hover:bg-white/[0.08] relative overflow-hidden">
                  <div className="absolute inset-0 bg-brand-accent/0 group-hover:bg-brand-accent/[0.02] transition-all duration-500" />
                  
                  <div className="relative z-10 text-brand-text-dim/30 group-hover:text-brand-accent group-hover:scale-110 transition-all duration-500 mb-3 drop-shadow-[0_0_8px_rgba(45,212,191,0)] group-hover:drop-shadow-[0_0_8px_rgba(45,212,191,0.15)]">
