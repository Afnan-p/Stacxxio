        ...
        <div className="p-8 border-t border-gray-100 flex items-center justify-between shrink-0 bg-gray-50/30 rounded-b-[24px]">
          ...
          {step < STEPS.length ? (
            ...
            <button 
              ...
              disabled={loading}
              className="h-[56px] px-8 bg-brand-accent text-brand-bg font-semibold rounded-[14px] hover:shadow-brand-glow transition-all flex items-center gap-2 disabled:opacity-50 shadow-md"
            >
