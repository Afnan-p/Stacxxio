...
const Team = () => {
  ...
  return (
    <section id="team" className="pt-16 pb-8 md:py-20 bg-white relative overflow-hidden mb-4 md:mb-16">
      <div className="container mx-auto px-6 md:px-10">
        ...
        <div className="flex md:flex-wrap overflow-x-auto md:overflow-visible md:justify-center gap-4 lg:gap-6 max-w-7xl mx-auto pb-8 -mx-6 px-6 md:mx-auto md:px-0 snap-x snap-mandatory md:snap-none scrollbar-hide">
          {loading ? (
            [...Array(5)].map((_, index) => (
              <div key={`skel-team-${index}`} className="w-[200px] sm:max-w-none shrink-0 snap-center sm:w-[calc(50%-1rem)] md:w-[calc(33.333%-1rem)] lg:w-[220px] xl:w-[240px] bg-white border border-[#E5E7EB] rounded-[1.5rem] overflow-hidden flex flex-col h-[320px] shadow-sm">
            ...
            team.map((member, index) => (
              <div
                key={member._id}
                className="w-[200px] sm:max-w-none shrink-0 snap-center sm:w-[calc(50%-1rem)] md:w-[calc(33.333%-1rem)] lg:w-[220px] xl:w-[240px] bg-brand-surface border border-[#E5E7EB] rounded-[1.5rem] overflow-hidden hover:shadow-xl transition-all duration-500 group flex flex-col"
              >
                ...
                <div className="p-5 text-center bg-white flex-grow">
                  <h3 className="text-base sm:text-lg font-bold text-brand-text mb-1 tracking-tight">{member.name}</h3>
